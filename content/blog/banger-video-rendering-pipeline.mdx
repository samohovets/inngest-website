...
Hi everyone! My name is [Igor Samokhovets](https://twitter.com/tequilafunks) and I'm a music producer who goes by the artist name Tequila Funk. In this blog post I will walk you through our video rendering pipeline built with Inngest, which powers Banger.Show.
...
We host our videos on a CDN, but sometimes, the sometimes video needs to be re-rendered. To make sure the CDN cache is always fresh, we purge it each time the video renders.
...
_You can reach out to Igor on [Twitter](https://twitter.com/tequilafunks) or listen to his music on [Spotify](https://open.spotify.com/artist/66PsDRGGiij2rHAK21GUEB)._
